...
func TestPermissionWithActualToolNames(t *testing.T) {
	...
	cases := []struct {
		...
		{"plan allows code_symbols", ModePlan, "code_symbols", true},
		{"plan allows command_catalog", ModePlan, "command_catalog", true},
		{"plan allows runtime_command", ModePlan, "runtime_command", true},
		...
		{"plan allows user_question_list", ModePlan, "user_question_list", true},
		{"plan allows user_question_wait", ModePlan, "user_question_wait", true},
		...
		{"plan denies worktree_run", ModePlan, "worktree_run", false},
		{"plan denies worktree_prune", ModePlan, "worktree_prune", false},
...
func TestAcceptEditsAutoApprovesWithoutPrompter(t *testing.T) {
	...
	autoApproved := []string{
		...
		"tool_search", "code_symbols", "command_catalog", "runtime_command", "todo_write", "task_list", "task_get", "task_output", "task_monitor", "ask_user_question", "user_question_list", "user_question_wait", "schedule_list",
