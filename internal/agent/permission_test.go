...
func TestAcceptEditsAutoApprovesWithoutPrompter(t *testing.T) {
	...
	autoApproved := []string{
		...
		"tool_search", "code_symbols", "command_catalog", "runtime_command", "todo_write", "task_list", "task_get", "task_output", "task_monitor", "ask_user_question", "user_question_list", "schedule_list",
