...
func isReadOnly(name string) bool {
	...
	case "read_file", "glob", "grep", "web_fetch", "web_search",
		...
		"tool_search", "code_symbols", "command_catalog", "runtime_command", "todo_write", "task_list", "task_get", "task_output", "task_monitor", "ask_user_question", "user_question_list", "schedule_list", "worktree_list",
