...
func (n *BrownfieldNode) Render(_ context.Context, state *RenderState) (string, error) {
	...
	b.WriteString("- Before final reporting, re-check the user's explicit completion requirements. A passing generic check is not enough if a required production diff, regression test, artifact, or named file is still missing.\n\n")
