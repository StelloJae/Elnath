...
Source: `benchmarks/results/month3-cycle-003/bugfix-report.md`

- Current vs baseline success delta: **+0.75**
- Current vs baseline verification delta: **+0.75**
- Current vs baseline recovery delta: **+0.25**

## Carry-forward canary
Source: `benchmarks/results/month3-cycle-003/canary/benchmark-report.md`
