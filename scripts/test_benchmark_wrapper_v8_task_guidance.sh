...
required_current = [
    ...
    "Do not add a new integration test unless",
    ...
    "Do not wait on `EE.once(body, 'end')` before consuming the response body",
    "Consume deterministically with `await body.text()`",
